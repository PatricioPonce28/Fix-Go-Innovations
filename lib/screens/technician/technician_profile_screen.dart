  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (_newProfileImage != null) {
        print('[SAVE PROFILE] Subiendo foto de perfil del técnico...');
      ...
      // Actualizar datos del técnico en Supabase
      print('[SAVE PROFILE] Actualizando perfil del técnico en BD...');
      ...
      print('[SAVE PROFILE] ✅ Perfil del técnico actualizado correctamente');
      setState(() {
        _isEditing = false;
        _isLoading = false;
      });
